  ...
  class ZentralApps {
    ...
    isSidebarRight() {
      ...
      if (document.documentElement.getAttribute("zen-right-side") === "true")
        return true;
      if (document.documentElement.getAttribute("zen-sidebar-right") === "true")
        return true;
      if (document.documentElement.getAttribute("zen-right-side") === "false")
        return false;
      if (
        document.documentElement.getAttribute("zen-sidebar-right") === "false"
      )
        return false;
    ...
    createContainers() {
      if (!this.#dom.grid) {
        ...
        this._autohideMouseMoveHandler = (e) => {
          ...
          if (isInsideGrid) {
            ...
            const isRevealed =
              ...
              this.#dom.utilitySection?.hasAttribute("data-utility-revealed");
            if (isRevealed) {
              this.scheduleAutohideCollapse(260);
              this.scheduleUtilityCollapse(260);
            }
        ...
        window.addEventListener("mousemove", this._autohideMouseMoveHandler, {
          passive: true,
        });
    ...
    renderGrid() {
      ...
      const oldAddBtn =
        document.querySelector("#zentral-apps-vertical-bar .zen-app-add-btn") ||
    ...
    syncVerticalBarTheme() {
      ...
      if (
        ...
        const bbOldGrad =
          zenBb.style.getPropertyValue("--zen-main-browser-background-old") ||
          "";
        grainOpacity =
          grainOpacity ||
    ...
    setupContextMenu() {
      ...
      if (window.MozXULElement?.parseXULToFragment) {
        ...
        (document.getElementById("mainPopupSet") || document.body).appendChild(
          frag,
        );
    ...
    isShortcutMatch(e, shortcutStr) {
      ...
      if (primaryKey === "SPACE") {
        return (
          eventKey === " " || eventKey === "SPACEBAR" || eventCode === "SPACE"
        );
      }
